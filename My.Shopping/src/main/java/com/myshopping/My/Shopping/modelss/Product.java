...
public class Product {
    ...
    /**
     * *whenever we will add a new prduct so a new unique id will automatically get generated
     */
            UUID id;
            String name;
            String category;
            int quantity;
            int price;
            AppUser user;//seller hoga ye->relationship between user table and product table
        //user which we will be considering here is only sellers type
